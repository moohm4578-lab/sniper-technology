...
const features = [
  ...
  { title: "واجهة النقل المخزني", link: "/software/warehouse-transfer" },
  { title: "واجهة إضافة العملاء", link: "/software/customers" },
  { title: "واجهة إضافة المواد", link: "/software/item" },
  { title: "واجهة إضافة الارصدة الاولية للمواد", link: "/software/opening-stock" },
  { title: "التصحيح المخزني والتلف", link: "/software/inventory-adjustment" },
  { title: "واجهة إضافة المستخدمين", link: "/software/users" },
  { title: "الحضور والإنصراف", link: "/software/attendance" },
  { title: "النسخ الإحتياطي", link: "/software/backup" },
  { title: "نماذج الطباعة", link: "/software/printing" },
  { title: "الطابعات والميزان الالكتروني", link: "/software/printers" },
];
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-7xl mx-auto">
        {features.map((item, index) => (
          <Link
            key={index}
            href={item.link}
            className="bg-zinc-900 border border-red-700 rounded-xl p-5 hover:bg-red-700 transition"
          >
